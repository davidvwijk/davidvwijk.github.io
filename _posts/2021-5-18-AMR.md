...
The robot has information about the map, and has a list of waypointa. Thus, the main task was to perform the localization and the motion planning, and execute the navigation.
