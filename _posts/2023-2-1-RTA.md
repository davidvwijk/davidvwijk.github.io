...
1) If Eq.\ref{eq: BC_subeq} is satisfied then the system is forward invariant in some set $$\mathcal{C}_S \subseteq \mathcal{C}_A$$ </li>
    $$\begin{align}
        \label{eq: BC1}
...
$$\begin{align} \label{eq: constraint_intermed}
